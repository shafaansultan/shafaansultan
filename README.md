...
📈 Currently growing towards production-grade AI system design
⚙️ Tech Stack & Tools
🐍 Core Languages
...
🧠 Currently Learning
⚙️ Building production RAG pipelines
🐳 Containerized ML model deployment with Docker & Kubernetes
☁️ Cloud-native AI architecture (AWS/GCP)
...
(e.g., Task automation modules — system control, web search, reminders, etc.)
(e.g., Python backend with modular skill/plugin architecture)
(e.g., Text-to-speech for voice responses)
